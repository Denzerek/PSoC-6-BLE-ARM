// ======================================================================
// BT_Central_Remote.v generated from TopDesign.cysch
// 12/06/2021 at 14:01
...
// bIncludeDriverToComponent_v1_0(PDL_DRIVER_NAME=ble, PDL_DRIVER_REQ_VERSION=2.0.0, PDL_DRIVER_SUBGROUP=Stack library, PDL_DRIVER_VARIANT=Profile - Host CM4 / Ctrl CM0+, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=bIncludeDriverToComponent_v1_0, CY_CONFIG_TITLE=IncludeBleLibs, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=BLE_1:IncludeBleLibs, CY_INSTANCE_SHORT_NAME=IncludeBleLibs, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=ble, CY_PDL_DRIVER_REQ_VERSION=2.0.0, CY_PDL_DRIVER_SUBGROUP=Stack library, CY_PDL_DRIVER_VARIANT=Profile - Host CM4 / Ctrl CM0+, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=BLE_1_IncludeBleLibs, )
...
module SCB_UART_PDL_v2_0_2 (
	...
	cy_clock_v1_0
		#(.id("033cda8b-7cf4-4094-b0d4-635c8444b67b/b68e5b9d-7828-482d-a282-930f990e3b3e"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_mxs40_gpio_v1_0
		#(.id("033cda8b-7cf4-4094-b0d4-635c8444b67b/65f3af6c-759b-4ccb-8c66-5c95ba1f5f4f"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("033cda8b-7cf4-4094-b0d4-635c8444b67b/b7e8018e-1ef7-49c0-b5a5-61641a03e31c"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("1"),
...
module CapSense_v3_0_3 ;
	...
	cy_mxs40_gpio_v1_0
		#(.id("dd08e906-8fd1-48ce-a973-4349fd8e8630/4db2e9d3-9f70-4f4e-a919-7eefada41863"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("dd08e906-8fd1-48ce-a973-4349fd8e8630/77fd7f86-2082-41fa-a471-914d5f07502d"),
		  .width(2),
		  .sio_grp_cnt(0),
		  .drive_mode("0,0"),
		  .ibuf_enabled("0,0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("dd08e906-8fd1-48ce-a973-4349fd8e8630/dbc12ae1-a607-4701-99cc-6261716a9147"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("dd08e906-8fd1-48ce-a973-4349fd8e8630/2605f567-73b7-435d-b3b9-174766b96934"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
	...
	cy_clock_v1_0
		#(.id("dd08e906-8fd1-48ce-a973-4349fd8e8630/8273f0d6-caef-4cc7-ad3c-09656b78e2cb"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("dd08e906-8fd1-48ce-a973-4349fd8e8630/0113321b-4a37-46f6-8407-2f8646c68756"),
		  .width(5),
		  .sio_grp_cnt(0),
	...
	cy_mxs40_gpio_v1_0
		#(.id("dd08e906-8fd1-48ce-a973-4349fd8e8630/8ed50244-d239-4c9b-9207-b8e71ce193dc"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
...
module SCB_I2C_PDL_v2_0_4 (
	...
	cy_clock_v1_0
		#(.id("016f8df5-0b41-4543-b8aa-1dc020095c88/b68e5b9d-7828-482d-a282-930f990e3b3e"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_mxs40_gpio_v1_0
		#(.id("016f8df5-0b41-4543-b8aa-1dc020095c88/69c3b5e8-b094-4d65-b96b-9f4f3a9a8641"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("4"),
		  .ibuf_enabled("1"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("016f8df5-0b41-4543-b8aa-1dc020095c88/2aab8a93-e7dd-4bd4-8210-42652cd079c5"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("4"),
		  .ibuf_enabled("1"),
...
module top ;
	...
	cy_mxs40_gpio_v1_0
		#(.id("3ec8b97e-d4e4-4a0b-a66c-5c4a16155a80"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
