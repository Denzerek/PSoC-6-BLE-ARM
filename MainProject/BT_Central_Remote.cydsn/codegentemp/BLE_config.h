...
#define CY_BLE_GATT_DB_INDEX_COUNT                  (0x000Du)
...
#define CY_BLE_CONFIG_GATT_DB_ATT_VAL_COUNT         (0x06u)
 ...
 */
#define CY_BLE_CUSTOMC_MOTOR_SERVICE_INDEX   (0x00u) /* Index of MOTOR service in the cy_ble_customCServ array */
#define CY_BLE_CUSTOMC_MOTOR_M1_CHAR_INDEX   (0x00u) /* Index of M1 characteristic */
#define CY_BLE_CUSTOMC_MOTOR_M1_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */
#define CY_BLE_CUSTOMC_MOTOR_M1_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x01u) /* Index of Client Characteristic Configuration descriptor */
#define CY_BLE_CUSTOMC_MOTOR_M2_CHAR_INDEX   (0x01u) /* Index of M2 characteristic */
#define CY_BLE_CUSTOMC_MOTOR_M2_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */
#define CY_BLE_CUSTOMC_MOTOR_M2_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x01u) /* Index of Client Characteristic Configuration descriptor */
#define CY_BLE_CUSTOMC_MOTOR_M1_REL_CHAR_INDEX   (0x02u) /* Index of M1_REL characteristic */
#define CY_BLE_CUSTOMC_MOTOR_M1_REL_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */
#define CY_BLE_CUSTOMC_MOTOR_M2_REL_CHAR_INDEX   (0x03u) /* Index of M2_REL characteristic */
#define CY_BLE_CUSTOMC_MOTOR_M2_REL_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */
#define CY_BLE_CUSTOMC_MOTOR_M3_CHAR_INDEX   (0x04u) /* Index of M3 characteristic */
#define CY_BLE_CUSTOMC_MOTOR_M3_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */
#define CY_BLE_CUSTOMC_MOTOR_M3_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x01u) /* Index of Client Characteristic Configuration descriptor */
#define CY_BLE_CUSTOMC_MOTOR_M4_CHAR_INDEX   (0x05u) /* Index of M4 characteristic */
#define CY_BLE_CUSTOMC_MOTOR_M4_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */
#define CY_BLE_CUSTOMC_MOTOR_M4_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x01u) /* Index of Client Characteristic Configuration descriptor */
#define CY_BLE_CUSTOMC_MOTOR_M3_REL_CHAR_INDEX   (0x06u) /* Index of M3_REL characteristic */
#define CY_BLE_CUSTOMC_MOTOR_M3_REL_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */
#define CY_BLE_CUSTOMC_MOTOR_M4_REL_CHAR_INDEX   (0x07u) /* Index of M4_REL characteristic */
#define CY_BLE_CUSTOMC_MOTOR_M4_REL_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */
