...
#define CY_BLE_MOTOR_M1_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */
...
#define CY_BLE_MOTOR_M2_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */
...
#define CY_BLE_MOTOR_M1_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x0013u) /* Handle of Custom Descriptor descriptor */
...
#define CY_BLE_MOTOR_M2_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x0017u) /* Handle of Custom Descriptor descriptor */
...
#define CY_BLE_MOTOR_M1_REL_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x001Bu) /* Handle of Custom Descriptor descriptor */
